-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('UNASSIGNED', 'STUDENT', 'TUTOR', 'ADMIN');
...
-- CreateIndex
CREATE INDEX "Availability_tutorId_startTime_idx" ON "Availability"("tutorId", "startTime");

-- CreateIndex
CREATE INDEX "Appointment_status_startTime_idx" ON "Appointment"("status", "startTime");

-- CreateIndex
CREATE INDEX "Appointment_tutorId_startTime_idx" ON "Appointment"("tutorId", "startTime");
