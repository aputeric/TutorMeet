...
export default function Home() {
  return (
    <div className="bg-background">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <p className="text-muted-foreground text-lg md:text-xl max-w-md">
                Book appointments, consult via video, and manage your learning
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Our platform makes learning accessible with just a few clicks
            </p>
          </div>
      ...
      {/* Pricing Section with green styling */}
      <section id="pricing" className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Choose the perfect consultation package that fits your learning
              needs
            </p>
          </div>
      ...
      {/* Testimonials with green accents */}
      <section className="py-20 bg-muted/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Hear from students and tutors who use our platform
            </p>
          </div>
            ...
            <CardContent className="p-8 md:p-12 lg:p-16 relative overflow-hidden">
              <div className="max-w-2xl relative z-10">
                ...
                <p className="text-lg text-muted-foreground mb-8">
                  Join thousands of users who have simplified their learning
