...
import { tutorFormSchema } from "@/lib/schema";
...
export default function OnboardingPage() {
  ...
  // Added missing onTutorSubmit function
  ...
  if (step === "choose-role") {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card
          className="border-emerald-900/20 hover:border-emerald-700/40 cursor-pointer transition-all"
          onClick={() => !loading && setStep("tutor-form")}
        >
          <CardContent className="pt-6 pb-6 flex flex-col items-center text-center">
            <div className="p-4 bg-emerald-900/20 rounded-full mb-4">
    ...
    return (
      <Card className="border-emerald-900/20">
        <CardContent className="pt-6">
          ...
          <form onSubmit={handleSubmit(onTutorSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Please provide a link to your Academic degree or certification
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                id="description"
                placeholder="Describe your expertise, services, and approach to student care..."
                rows="4"
