    ...
    <div>
      <Card className="bg-muted/20 border-emerald-900/20">
        <CardHeader>
          ...
          <CardDescription>
            Review and approve tutor payout requests
          </CardDescription>
        </CardHeader>
        <CardContent>
          {payouts.length === 0 ? (
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1">
                          <h3 className="font-medium text-white">
                            Tr. {payout.tutor.name}
                          </h3>
                          <p className="text-sm text-muted-foreground">
                            {payout.tutor.specialty}
                          </p>
            ...
            <div className="space-y-6 py-4">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-white font-medium">Tutor Information</h3>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">{selectedPayout.tutor.email}</p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
                      Specialty
                    ...
                    <p className="text-white">
                      {selectedPayout.tutor.specialty}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm font-medium text-muted-foreground">
              ...
              {selectedPayout.tutor.credits < selectedPayout.credits && (
                <Alert variant="destructive">
                  <AlertCircle className="h-4 w-4" />
                  <AlertDescription>
                    Warning: Tutor currently has only{" "}
                    {selectedPayout.tutor.credits} credits but this payout
              ...
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <ul className="mt-2 space-y-1 list-disc pl-4">
                    <li>
                      Deduct {selectedPayout.credits} credits from Tr.{" "}
                      {selectedPayout.tutor.name}'s account
                    </li>
