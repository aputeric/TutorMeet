// /app/tutors/[id]/_components/tutor-profile.jsx
"use client";
...
export function TutorProfile({ tutor, availableDays }) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      {/* Left column - Tutor Photo and Quick Info (fixed on scroll) */}
      ...
      {/* Right column - Tutor Details and Booking Section */}
              ...
              <CardContent className="space-y-6">
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground">
                      This tutor doesn&apos;t have any available appointment
