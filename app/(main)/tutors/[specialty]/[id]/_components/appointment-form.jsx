...
export function AppointmentForm({ tutorId, slot, onBack, onComplete }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="space-y-2">
        <Label htmlFor="description">
          Describe your Learning Outcomes (optional)
        </Label>
        <Textarea
          id="description"
          placeholder="Please provide any details about your learning Outcomes or what you'd like to discuss in the appointment..."
          value={description}
          onChange={(e) => setDescription(e.target.value)}
          className="bg-background border-emerald-900/20 h-32"
        />
        <p className="text-sm text-muted-foreground">
          This information will be shared with the tutor before your
          appointment.
        </p>
      </div>
